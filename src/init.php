 ...
 * @since 1.0.0
 */
function testimonials_block_cgb_block_assets() { // phpcs:ignore
	// Register block styles for both frontend + backend.
	wp_register_style(
		'testimonials_block-cgb-style-css', // Handle.
	...
	wp_register_script(
		'testimonials_block-cgb-block-js', // Handle.
	...
	wp_register_style(
		'testimonials_block-cgb-block-editor-css', // Handle.
	...
	wp_localize_script(
		'testimonials_block-cgb-block-js',
